...
export class NavDrawer {
    ...
    constructor() {
		...
		if(window.innerWidth < 767) {
			...
			gsap.set(this.navMask, { yPercent: -100 });
		}
    ...
    open() {
		...
		this.timeline
			...
			.to(this.navMask, { yPercent: 0, duration: 0.3, force3D: true, ease: "sine.in" }, "<");
    ...
    close() {
		...
		this.timeline
			...
			.to(this.navMask, { yPercent: -100, duration: 0.3, force3D: true, ease: "sine.in" }, "<")
