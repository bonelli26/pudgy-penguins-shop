...
<section class="about-section">
	<?php foreach ($data->about_text_repeater as $block) { ?>
		<div class="text-block mw">
			<?php if($block->icon_check === true) { ?>
				<img class="preload icon" data-preload-desktop="<?php echo $block->icon->url ?>" data-preload-mobile="<?php echo $block->icon->url ?>">
			<?php } ?>
			<h2><?php echo $block->text[0]->text ?></h2>
...
<section class="bottom-marquee max-width">
	...
	<div class="marquee mw">
		<div class="inner" data-dur="<?php echo $data->press_marquee_duration[0]->text; ?>">
			<div class="group">
				<?php foreach ($data->press_marquee as $block) { ?>
					<img class="preload" data-preload-desktop="<?php echo $block->image->url ?>" data-preload-mobile="<?php echo $block->image->url ?>">
				<?php } ?>
			</div>
...
<section class="best-sellers mw max-width">
	<div class="top">
		<h3><?php echo $data->best_sellers_header[0]->text ?></h3>
	...
	<div class="best-sellers-wrapper slider no-drag-free no-loop no-loop-mobile" data-at="767" data-align="center">
		<div class="slides">
			<div class="inner">
				<?php foreach ($data->best_sellers as $slide) { ?>
						...
						<span>
							...
							<div class="block">
								<div class="img-wrapper">
									<img class="preload" data-preload-desktop="<?php echo $slide->image->url ?>" data-preload-mobile="<?php echo $slide->image->url ?>">
